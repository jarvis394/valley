/*
  ...
  - The primary key for the `TranslationStrings` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- AlterTable
ALTER TABLE "TranslationStrings" DROP CONSTRAINT "TranslationStrings_pkey",
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ALTER COLUMN "projectId" SET DATA TYPE TEXT,
ADD CONSTRAINT "TranslationStrings_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "TranslationStrings_id_seq";
