...
const CenterCover: React.FC<CoverDesignProps> = ({
  title,
  cover,
  dateShot,
  timeZone,
  ...
  return (
    <div
      ...
      className={cn(
        'fade-in relative flex h-full w-full flex-col justify-end bg-stone-950 bg-cover bg-no-repeat text-stone-100 before:absolute before:inset-0 before:h-full before:w-full before:bg-stone-950/12 before:content-[""]',
        className
      )}
    >
      <div
